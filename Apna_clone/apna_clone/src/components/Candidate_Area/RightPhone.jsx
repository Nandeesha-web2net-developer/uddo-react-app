...
const RightPhone = () => {
    return (
        <div className='h-[450px] mt-4 overflow-hidden relative w-full cursor-pointer rounded-xl  border border-[#C7DAF4] bg-[#F1F6FF] bg-cover bg-center p-[16px]'>

            <div className="z-[1] relative flex h-full flex-col justify-between ">
                <div>
                    <h2 className="mb-[16px] text-[18px] font-bold leading-7 text-[#003C96]">Track your applications, connect with HRs & a lot more on the app</h2>
                ...
                <button type="button" className="flex mt-[85px] w-full items-center justify-center rounded-[4px] bg-[#1F8368] p-[8px] text-center text-[14px] font-semibold leading-5 text-[#fff] md:p-[7px]">
                    <span>Download Uddo App Now</span>

                </button>
            </div>
            <img src={sidebar_right} className='z-[0] absolute w-[40%] bottom-[-10px] left-[30%]' />
        </div>
    )
}
