...
export const jobsByCompany=[
    ...
    {
    title:'Blinkit Private Limited',
    path:'/'
    },
    {
    title:'Anaya Enterprises',
    path:'/'
    },
    {
    title:'Zepto',
...
export const  review =[
    {
        ...
        name:'placeholder1',
        desc:"'Thanks Apna for helping me find a job without much hassle. If you are a fresher or a skilled person with expert knowledge in a specific field, you can easily find a job through the Apna app.'"
    },
    {
        img:ReviewPlaceholder,
        name:'placeholder2',
