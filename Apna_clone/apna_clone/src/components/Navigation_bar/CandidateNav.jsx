  ...
  return (
   <nav className='relative flex bg-white h-16 items-center justify-between w-full px-10'>
    <div className='flex w-2/5'>
      ...
      <Link className='text-base px-5 text-dark font-medium font-family-roboto flex items-center'><FaUser className='text-green'/><span className='pl-1' >Candidate Login</span></Link>
    </div>
