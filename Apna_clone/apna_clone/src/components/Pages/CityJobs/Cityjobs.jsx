...
const Cityjobs = () => {
    ...
    const cityJobs = job.filter(item => item.city.trim().toLowerCase() === 'bangalore');
    const lastIndex = currentPage * recordsPerPage;
    const firstIndex = lastIndex - recordsPerPage;
    const records = cityJobs.slice(firstIndex, lastIndex)
    const npage = Math.ceil(cityJobs.length / recordsPerPage)
