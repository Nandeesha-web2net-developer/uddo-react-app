...
import SearchResultJobs from './SearchResultJobs'
import Rightsidebar from '../../Right_sidebars/Rightsidebar'


const SearchResultJobsList = () => {
    ...
    return (
        <div className='h-auto bg-gray' id="Fresrsjobs">
            ...
            <div className='px-[10%] pt-24 text-violet text-[20px] font-bold'><h1>550+ Jobs </h1></div>
            ...
            <div className='sm:px-4 md:px-[10%] justify-between flex sm:flex-col md:flex-row gap-5 py-8'>
                ...
                <div className='md:w-[50%] sm:w-[100%]'> <SearchResultJobs /></div>
