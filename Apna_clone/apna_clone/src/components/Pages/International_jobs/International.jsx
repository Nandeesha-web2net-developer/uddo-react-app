...
const International = () => {
    ...
    const PartTimeJobs = job.filter(item => item.jobtype.trim().toLowerCase() === 'part time');
    const lastIndex = currentPage * recordsPerPage;
    const firstIndex = lastIndex - recordsPerPage;
    const records = PartTimeJobs.slice(firstIndex, lastIndex)
    const npage = Math.ceil(PartTimeJobs.length / recordsPerPage)
    ...
    return (
        ...
        <nav>
        <ul className='flex mt-10 mb-10 gap-4 items-center justify-center'>
            <li>
