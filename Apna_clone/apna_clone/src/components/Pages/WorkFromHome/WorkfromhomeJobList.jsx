...
import WorkfromhomeJobs from './WorkfromhomeJobs'
import Rightsidebar from '../../Right_sidebars/Rightsidebar'

const WorkfromhomeJobList = () => {
    return (
        <div className='h-auto bg-gray' id="Fresrsjobs">
            <div className='bg-white fixed z-[200]'>
                < Navabar />
            </div>
            <div className='px-[10%] pt-24 text-violet text-[20px] font-bold'><h1>250+ Work From Home Jobs</h1></div>
            ...
            <div className='sm:px-4 md:px-[10%] justify-between flex sm:flex-col md:flex-row gap-5 py-8'>
                ...
                <div className='md:w-[50%] sm:w-[100%]'> <WorkfromhomeJobs /></div>
...
export default WorkfromhomeJobList