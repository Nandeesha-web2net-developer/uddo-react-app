...
const WorkfromhomeJobs = () => {
    ...
    const workFromHomeJobs = job.filter(item => item.workmode && item.workmode.trim().toLowerCase() === 'work from home');
    const lastIndex = currentPage * recordsPerPage;
    const firstIndex = lastIndex - recordsPerPage;
    const records = workFromHomeJobs.slice(firstIndex, lastIndex)
    const npage = Math.ceil(workFromHomeJobs.length / recordsPerPage)
