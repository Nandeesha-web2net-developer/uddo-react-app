...
const Rightsidebar = () => {
    return (
        <div className='h-[450px] overflow-hidden relative w-full cursor-pointer rounded-xl  border border-[#C7DAF4] bg-[#F1F6FF] bg-cover bg-center p-[16px]'>

            <div className="z-[1] relative flex h-full flex-col justify-between ">
                <div>
                    <h2 className="mb-[16px] text-[22px] font-bold leading-7 text-[#003C96]">Login with Uddo and experience more !</h2>
